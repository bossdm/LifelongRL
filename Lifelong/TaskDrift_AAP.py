...
class TaskDriftAAP(SSA_gradientQ,TaskDriftBase):
    epsilon_change=False
    def __init__(self,SSAgradientQ_Params):
        SSA_gradientQ.__init__(self,**deepcopy(SSAgradientQ_Params))
    ...
    def create_similar_policy(self):
        ...
        new_instance = SSA_gradientQ(self.SSA_gradientQ_Params)

...
class SLAM_Learner(CompleteLearner):
    def __init__(self):
...
MAP_SIZE_METERS = 32
import sys
sys.path.append('${HOME}/BreezySLAM-master/')
from breezyslam.algorithms import Deterministic_SLAM, RMHC_SLAM
from breezyslam.components import Laser
from breezyslam.robots import WheeledRobot

from examples.mines import MinesLaser, Rover, load_data
from examples.progressbar import ProgressBar
from examples.pgm_utils import pgm_save
